...
from airsenal.framework.env import get_airsenal_env_value
...
from .configs.benchmark_config import get_config, BenchmarkConfig
...
class BenchmarkRunner:
    ...
    def benchmark_context(self, test_name: str):
        ...
        try:
            ...
            print(f"  Duration: {result['duration']:.4f}s, Memory: {result['memory_delta_mb']:.2f}MB")
...
def generate_test_data(
    ...
    if data_type == "player_predictions":
        ...
        return {
            ...
            "features": {
                feature: np.random.uniform(0, 10, size)
...
def compare_to_baseline(
    ...
    comparison["summary"] = {
        ...
        "avg_change_percent": current_df["duration"].mean() / baseline_df["duration"].mean() * 100 - 100
    }

    ...
    try:
        ...
        if runner.feature_store:
            with runner.benchmark_context("example_feature_retrieval"):
                ...
                runner.feature_store.get_features(
                    entity_type="player",
        ...
        if runner.redis_cache:
            ...
            with runner.benchmark_context("example_cache_operations"):
                ...
                # Test GET operation
                runner.redis_cache.get("benchmark:example")
        ...
        if runner.session:
            try:
                with runner.benchmark_context("example_database_query"):
                    ...
                    runner.session.query(Player).limit(10).all()
        ...
        if runner.results:
            ...
            if threshold_check["pass"]:
                ...
                print(
                    f"⚠️ {threshold_check['total_violations']} threshold violations detected"
                )
...
def demonstrate_dashboard():
    ...
    try:
        ...
        # Create dashboard
        dashboard = PerformanceDashboard(data_dir="benchmarks/reports", port=8080)

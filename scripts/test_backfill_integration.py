...
def main():
    ...
    if failed == 0:
        ...
        print("  3. Start with a small test backfill: python airsenal/scripts/backfill_xg_data.py --season 2324 --gameweeks 1 --dry-run")
        return 0
    else:
        print("⚠️  Some tests failed. Please check the issues above before using the backfill system.")
        return 1

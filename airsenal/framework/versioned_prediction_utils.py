...
class VersionedPredictionManager:
    ...
    def fit_and_register_player_model(
        ...
        if register_model:
            ...
            self.model_manager.register_model_version(
                ...
                or {"position": position, "season": season, "gameweek": gameweek},
    ...
    def run_versioned_predictions(
        ...
        fixtures = get_fixtures_for_gameweek(
            gw_range, season=season, dbsession=self.dbsession
        )
        fixture_goal_probs = get_goal_probabilities_for_fixtures(
            fixtures, team_model, max_goals=10
        )
        ...
        players = list_players(
            season=season, gameweek=gw_range[0], dbsession=self.dbsession
        )
        ...
        try:
            ...
            if len(prob_score) > 0:
                ...
                total_probs = [
                    s + a + n
                    for s, a, n in zip(
                        prob_score, prob_assist, prob_neither, strict=False
                    )
                ]
    ...
    if use_versioned_models:
        ...
        return manager.run_versioned_predictions(
            ...
            **{
                ...
                if k
                in ["include_bonus", "include_cards", "include_saves", "tag_prefix"]
            },
        )

...
def create_weight_matrix_from_config(config_path: Optional[str] = None,
                                     experimental_config: Optional[str] = None) -> PerformanceWeightMatrix:
    """
    ...
    if experimental_config:
        if 'experimental_configs' not in config:
            raise ValueError("No experimental_configs section found in configuration")
    ...
    difficulty_adjustments = {
        int(k): v for k, v in difficulty_adjustments.items()
    }
...
def save_weight_matrix_to_yaml(weight_matrix: PerformanceWeightMatrix,
...
def reload_default_weight_matrix(config_path: Optional[str] = None) -> PerformanceWeightMatrix:
    """

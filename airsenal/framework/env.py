...
AIRSENAL_MODEL_ENABLE_S3 = get_env(
    "AIRSENAL_MODEL_ENABLE_S3", lambda x: x.lower() == "true"
)
...
AIRSENAL_REDIS_ENABLE = (
    get_env("AIRSENAL_REDIS_ENABLE", lambda x: x.lower() == "true") or False
)
AIRSENAL_REDIS_CLUSTER = (
    get_env("AIRSENAL_REDIS_CLUSTER", lambda x: x.lower() == "true") or False
)
...
AIRSENAL_REDIS_CONNECTION_TIMEOUT = (
    get_env("AIRSENAL_REDIS_CONNECTION_TIMEOUT", float) or 5.0
)
...
# Performance optimization environment variables
AIRSENAL_PERFORMANCE_BATCH_SIZE = get_env("AIRSENAL_PERFORMANCE_BATCH_SIZE", int) or 50
AIRSENAL_PERFORMANCE_MAX_WORKERS = get_env("AIRSENAL_PERFORMANCE_MAX_WORKERS", int) or 4
AIRSENAL_PERFORMANCE_CACHE_SIZE = get_env("AIRSENAL_PERFORMANCE_CACHE_SIZE", int) or 1000
AIRSENAL_PERFORMANCE_MEMORY_LIMIT_GB = get_env("AIRSENAL_PERFORMANCE_MEMORY_LIMIT_GB", float) or 2.0
AIRSENAL_PERFORMANCE_ENABLE_PROFILING = (
    get_env("AIRSENAL_PERFORMANCE_ENABLE_PROFILING", lambda x: x.lower() == "true") or False
)

...
from benchmarks.utils import BenchmarkRunner, compare_to_baseline, check_thresholds
...
def run_framework_benchmarks(runner: BenchmarkRunner) -> None:
    ...
    try:
        ...
        from benchmarks.framework.test_redis_cache_benchmarks import RedisCacheBenchmarks
        from benchmarks.framework.test_model_versioning_benchmarks import ModelVersioningBenchmarks
        from benchmarks.framework.test_base_models_benchmarks import BaseModelsBenchmarks
...
def run_integration_benchmarks(runner: BenchmarkRunner) -> None:
    ...
    try:
        from benchmarks.integration.test_prediction_pipeline_benchmarks import PredictionPipelineBenchmarks
        from benchmarks.integration.test_optimization_benchmarks import OptimizationBenchmarks
...
def run_load_tests(runner: BenchmarkRunner) -> None:
    ...
    try:
        from benchmarks.load_testing.prediction_load_test import run_prediction_load_test
...
def main():
    ...
    parser.add_argument(
        "--profile",
        action="store_true",
        help="Enable CPU profiling (slower)"
    )

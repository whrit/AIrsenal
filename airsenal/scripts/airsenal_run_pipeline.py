    ...
    with session_scope() as dbsession:
        ...
        try:
            ...
            if not version_compatible:
                click.echo(
                    "ERROR: Database version is incompatible with application version.",
                    err=True,
                )
                click.echo(
                    "Please run migration or use a compatible database version.",
                    err=True,
                )
                return
            ...
            click.echo(
                "Please check your database version and migrate if necessary.", err=True
            )
            return

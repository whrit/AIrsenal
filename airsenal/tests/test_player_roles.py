...
class TestEdgeCases:
    ...
    def test_insufficient_penalty_data(self):
        ...
        stats = {
            123: PenaltyStatistics(123, "Test Player", "TEST")
        }
...
class TestHistoricalAccuracy:
    ...
    def test_accuracy_calculation_perfect_match(self):
        ...
        with patch.object(analyzer, 'get_all_current_penalty_takers') as mock_predictions:
            with patch('airsenal.framework.player_roles.session_scope') as mock_session_scope:
                # Mock predictions
    ...
    def test_accuracy_target_achievement(self):
        ...
        assert confidence >= 0.95, f"Confidence {confidence} should be >= 0.95 for ideal conditions"
...
class TestCoverage:
    ...
    def test_convenience_functions(self):
        ...
        with patch('airsenal.framework.player_roles.PenaltyTakerAnalyzer') as mock_analyzer_class:
            mock_analyzer = Mock()
            mock_analyzer_class.return_value = mock_analyzer
            
            # Test get_team_penalty_takers
            get_team_penalty_takers("TEST", "2024-25")
            mock_analyzer.identify_team_penalty_takers.assert_called_with("TEST", "2024-25")
...
class TestPerformance:
    ...
    def test_large_dataset_performance(self):
        ...
        for player_id, stats in large_stats.items():

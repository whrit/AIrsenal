...
class TestRedisSerializer:
    ...
    def setup_method(self):
        ...
        self.serializer = RedisSerializer(CompressionType.NONE)  # No compression for easier testing
    ...
    def test_compression_reduces_size(self):
        ...
        deserialized_compressed = self.serializer_zstd.deserialize(serialized_compressed)
...
class TestRedisCache:
    ...
    def setup_method(self):
        ...
        with patch('airsenal.framework.redis_cache.REDIS_AVAILABLE', True):
            with patch('airsenal.framework.redis_cache.redis') as mock_redis_module:
                ...
                self.redis_cache = RedisCache(namespace="test", version="v1", default_ttl=60)
    ...
    def test_prediction_cache_operations(self):
        ...
        retrieved = self.redis_cache.get_prediction_cache(
...
class TestFeatureCacheManagerIntegration:
    ...
    def setup_method(self):
        ...
        with patch('airsenal.framework.feature_store.redis_cache', self.mock_redis_cache):
            self.cache_manager = FeatureCacheManager(
                dbsession=self.mock_session,
                default_ttl=3600
            )
    ...
    def test_cache_invalidation_all_levels(self):
        ...
        # Set up memory cache
        self.cache_manager._memory_cache["test_feature:player:123:"] = ("value", datetime.now())
    ...
    def test_prediction_cache_warming(self):
        ...
        for player_id in player_ids:
            for gameweek in gameweeks:
                cached = self.redis_cache.get_prediction_cache(player_id, gameweek, season)
    ...
    def test_feature_cache_warming(self):
        ...
        for feature_name in feature_names:
            for entity_id in entity_ids:
                cached = self.redis_cache.get_feature_cache(feature_name, entity_type, entity_id)

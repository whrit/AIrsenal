...
from airsenal.framework.schema import Base, DatabaseVersion, MigrationHistory, SchemaCompatibility
...
class TestVersionUtilities:
    ...
    def test_get_current_database_version_exists(self, test_session, sample_database_version):
...
class TestCompatibilityChecking:
    ...
    def test_version_compatibility_with_matrix(self, test_session, sample_compatibility_matrix):
...
class TestStartupValidation:
    ...
    def test_validate_database_startup_compatible(self, test_session, sample_database_version):
    ...
    def test_validate_database_startup_incompatible(self, mock_get_version, test_session, sample_database_version):
...
class TestMigrationRecording:
    ...
    def test_record_migration(self, test_session, sample_database_version):
        ...
        old_version = (
            test_session.query(DatabaseVersion)
            .filter_by(version="1.11.0")
            .first()
        )
...
class TestDatabaseInfo:
    ...
    def test_get_database_info_with_version(self, test_session, sample_database_version):
...
class TestErrorHandling:
    ...
    def test_database_version_error(self):
        ...
        with pytest.raises(DatabaseVersionError):
            raise DatabaseVersionError("Test error")

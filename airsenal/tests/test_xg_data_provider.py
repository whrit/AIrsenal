...
class TestDataTransformer:
    ...
    def test_extract_xg_stats_from_sportmonks(self):
        ...
        stat_data = {
            "data": {"expected_goals": 0.5, "expected_assists": 0.3, "xgi": 0.8}
        }
            ...
            "data": [
                {
                    ...
                    "data": {"expected_goals": 0.5, "expected_assists": 0.3},
                }
            ]
        }
...
class TestSportmonksProvider:
    ...
    def test_sportmonks_initialization_with_config(self):
        ...
        config = ProviderConfig(
            api_key="test_key", base_url="https://api.sportmonks.com/v3/football/"
        )
...
class TestIntegration:
    ...
    def test_sync_xg_data_for_gameweek(self, mock_session_scope):
        ...
        manager.sync_xg_data_for_gameweek("2023-24", 15)
